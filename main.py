...
async def srt_gen(video_id):   
    try:
        ...
        raise HTTPException(status_code=404, detail="Opps, seems like video in English language based, sorry at this moment we only convert English audio at this time")
    return sub_srt
